...
namespace OurNewProject.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BranchName,Address,PhoneNumber,OcHours")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BranchName,Address,PhoneNumber,OcHours")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
